...
def test_predict_rejects_unknown_field(monkeypatch):
    monkeypatch.setenv("INFERENCE_API_KEY", VALID_KEY)
    payload = {
        "records_affected": 1, "detection_time_hours": 1, "ransom_demand_usd": 0,
        "sector": "finance", "region": "APAC", "attack_type": "phishing",
        "threat_actor": "unknown", "data_exfiltration": "No", "zero_day_used": "No",
        "extra": 1,
    }
